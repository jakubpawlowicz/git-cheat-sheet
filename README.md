...
git config --global alias.psc "push --set-upstream origin $(git rev-parse --abbrev-ref HEAD)"
git config --global alias.psd "push origin :$(git rev-parse --abbrev-ref HEAD)"
